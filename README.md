...
Так как сервер [Nakama WoW](https://nakama-wow.org/) использует современные
переводы на старой версии игры, квестовые аддоны не могут сопоставить
их со своими переводами 2007 года. По этой причине многие квесты
не отслеживаются на русском интерфейсе клиента. Данная версия аддона
*pfQuest* решает эту проблему.

- Удалены все переводы кроме enUS и ruRU для экономии веса.
- Обновлены переводы предметов, нпц, объектов и квестов.
